...
#[path = "clang_oracle/deep_c99_requested_stress.rs"]
...
#[path = "clang_oracle/deep_c99_struct_string_pointer_field_offsets.rs"]
mod deep_c99_struct_string_pointer_field_offsets;

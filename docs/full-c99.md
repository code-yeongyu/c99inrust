...
observable stdout plus exit code. The suite currently contains 486 oracle tests.
...
`sizeof`, char signedness, `long long`, decimal floats, hex float constants,
and `_Complex` scalar/layout/arithmetic lanes.
